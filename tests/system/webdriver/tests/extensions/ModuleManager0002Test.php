...
class ModuleManager0001Test extends JoomlaWebdriverTestCase
{
	...
	public function addModule_ArticleCategories_ModuleAdded()
	{
		...
		$this->assertTrue($this->itemExist($categoryName1, 'a'));
	...
	public function addModule_ArticleCategories_ModuleAdded_2()
	{
		...
		$this->assertTrue($this->itemExist($categoryName1, 'a'));
		$this->assertTrue($this->itemExist($categoryName2, 'a'));
		$d->findElement(By::xPath("//a[contains(text(),'" . $categoryName1 . "')]"))->click();
		$this->assertTrue($this->itemExist($articleName1, 'a'));
		$d->findElement(By::xPath("//a[contains(text(),'" . $categoryName2 . "')]"))->click();
	...
	public function addModule_ModuleTypeMenu_ModuleAdded()
	{
		...
		$this->menuItemsManagerPage->addMenuItem($menuTitle1, $menuType);
		...
		$this->siteHomePage = $this->getPageObject('SiteContentFeaturedPage');
		$this->assertTrue($this->itemExist($title, 'h3'));
		$this->assertTrue($this->itemExist($menuTitle1, 'a'));
		$this->assertTrue($this->itemExist($menuTitle2, 'a'));
	...
	public function addModule_MenuItemSingleArticle_ModuleAdded()
	{
		...
		$this->assertFalse($this->menuItemsManagerPage->getRowNumber($menuTitle1), 'Test menu item should not be present');
		$this->assertFalse($this->menuItemsManagerPage->getRowNumber($menuTitle2), 'Test menu item should not be present');
		$this->menuItemsManagerPage->addMenuItem($menuTitle1, $menuType, array('article' => $articleName1));
		$message = $this->menuItemsManagerPage->getAlertMessage();
		$this->assertContains('Menu item successfully saved', $message, 'Menu save should return success', true);
		...
		$this->assertTrue($this->itemExist($menuTitle1, 'a'));
		$this->assertTrue($this->itemExist($menuTitle2, 'a'));
		$d->findElement(By::xPath("//a[contains(text(),'" . $menuTitle1 . "')]"))->click();
		$this->assertTrue($this->itemExist($articleName1, 'a'));
		$d->findElement(By::xPath("//a[contains(text(),'" . $menuTitle2 . "')]"))->click();
		$this->assertTrue($this->itemExist($articleName2, 'a'));
	...
	public function addModule_MenuItemsCategoryBlog_ModuleAdded()
	{
		...
		$this->menuItemsManagerPage->addMenuItem($menuItem1, $menuType, array('Category' => $categoryName1));
		$message = $this->menuItemsManagerPage->getAlertMessage();
		$this->assertContains('Menu item successfully saved', $message, 'Menu save should return success', true);
		...
		$this->siteHomePage = $this->getPageObject('SiteContentFeaturedPage');
		$this->assertTrue($this->itemExist($title, 'h3'));
		$this->assertTrue($this->itemExist($menuItem1, 'a'));
		$this->assertTrue($this->itemExist($menuItem2, 'a'));
		$d->findElement(By::xPath("//a[contains(text(),'" . $menuItem1 . "')]"))->click();
		$this->assertTrue($this->itemExist($articleName1, 'a'));
		$this->assertTrue($this->itemExist($articleName2, 'a'));
		$d->findElement(By::xPath("//a[contains(text(),'" . $menuItem2 . "')]"))->click();
		$this->assertTrue($this->itemExist($articleName3, 'a'));
