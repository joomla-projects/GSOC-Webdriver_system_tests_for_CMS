...
class ContactManager0002Test extends JoomlaWebdriverTestCase
{
  ...
  /**
	...
	public function setFilter_SetFilterValues_ShouldExecuteFilter()
	{
		...
		$this->assertGreaterThanOrEqual(1, $this->contactManagerPage->getRowNumber($contactName), 'Contact should be in row 8');
	...
	public function setFilter_TestFilters_ShouldFilterContacts()
	{
		...
		$this->assertGreaterThanOrEqual(1, $this->contactManagerPage->getRowNumber($contactName_1), 'Contact should be in row 8');
