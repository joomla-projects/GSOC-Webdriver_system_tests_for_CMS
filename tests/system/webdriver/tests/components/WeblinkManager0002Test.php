...
class WeblinkManager0002Test extends JoomlaWebdriverTestCase
{
	...
	public function setFilter_SetFilterValues_ShouldExecuteFilter()
	{
		...
		$this->assertGreaterThanOrEqual(1, $this->weblinkManagerPage->getRowNumber($weblinkName), 'Weblink should be in row 10');
	...
	public function setFilter_TestFilters_ShouldFilterWeblinks()
	{
		...
		$this->assertGreaterThanOrEqual(1, $this->weblinkManagerPage->getRowNumber($weblinkName_1), 'Weblink should be in row 10');
